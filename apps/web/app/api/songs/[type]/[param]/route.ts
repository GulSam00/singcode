...
import { getSong, getSinger, getComposer, getLyricist, getNo, getRelease, getPopular, Brand, Period } from '@repo/api';

export async function GET(request: NextRequest, { params }: { params: { type: string; param: string } }) {
  try {
